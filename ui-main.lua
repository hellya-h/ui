--// Fancy Loading Screen UI by @thebestexploiterr //
-- Updated: Animated purple-pink glow, better spacing, logo on left
...
if playerGui:FindFirstChild("EverythingScriptUI") then
    playerGui:FindFirstChild("EverythingScriptUI"):Destroy()
end

-- Create GUI
local gui = Instance.new("ScreenGui")
guizName = "EverythingScriptUI"
...
subtitle.Position = UDim2.new(0, 0, 0.325, 0)
subtitle.BackgroundTransparency = 1
subtitle.TextScaled = true
subtitle.Font = Enum.Font.Gotham
title.TextColor3 = Color3.fromRGB(220, 180, 255)
subtitle.TextStrokeColor3 = Color3.fromRGB(255, 0, 255)
...
logo.Position = UDim2.new(0.32, -100, 0.42, -20)
logo.BackgroundTransparency = 1
logo.Image = "rbxassetid://17284584261" -- replace with your ID
logo.Parent = background

-- Logo rotation
TweenService:Create(logo, TweenInfo.new(20, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {
    Rotation = 360
}):Play()

-- Loading bar container
local loadingContainer = Instance.new("Frame")
loadingContainer.Size = UDim2.new(0.3, 0, 0, 20)
loadingContainer.Position = UDim2.new(0.5, 0, 0.45, 0)
loadingContainer.AnchorPoint = Vector2.new(0.5, 0)
loadingContainer.BackgroundColor3 = Color3.fromRGB(40, 0, 60)
...
-- Animation light inside bar
local shine = Instance.new("Frame")
shine.Size = UDim2.new(0.2, 0, 1, 0)
shine.Position = UDim2.new(-0.2, 0, 0, 0)
shine.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
shine.BackgroundTransparency = 0.6
shine.Parent = loadingBar

local shineCorner = Instance.new("UICorner")
shineCorner.CornerRadius = UDim.new(0, 10)
shineCorner.Parent = shine

-- Animate bar and shine
TweenService:Create(loadingBar, TweenInfo.new(180, Enum.EasingStyle.Linear), {
    Size = UDim2.new(1, 0, 1, 0)
}):Play()

TweenService:Create(shine, TweenInfo.new(3, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {
    Position = UDim2.new(1, 0, 0, 0)
}):Play()

-- Final message after 3 minutes
